<?php /* Smarty version Smarty-3.1.13, created on 2013-12-28 18:43:36
         compiled from "./templates/mpos/account/transactions/default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16310784752beab58cb74c5-79207469%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2b8c9b6cdbc8e8e2339f2aafe17eef5ea68a8ead' => 
    array (
      0 => './templates/mpos/account/transactions/default.tpl',
      1 => 1388225756,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16310784752beab58cb74c5-79207469',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52beab5908de83_11783424',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52beab5908de83_11783424')) {function content_52beab5908de83_11783424($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include './include/smarty/libs/plugins/function.html_options.php';
...
">
          ...
          <td><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['TRANSACTIONS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['transaction']['index']]['coin_address'],20,"...",true,true);?>
</td>
          <td><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['TRANSACTIONS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['transaction']['index']]['txid'],20,"...",true,true);?>
</td>
          <td><?php if ($_smarty_tpl->tpl_vars['TRANSACTIONS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['transaction']['index']]['height']==0){?>n/a<?php }else{ ?><a href="<?php echo $_SERVER['PHP_SELF'];?>
