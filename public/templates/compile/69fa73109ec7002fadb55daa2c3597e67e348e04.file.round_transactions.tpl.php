<?php /* Smarty version Smarty-3.1.13, created on 2014-01-06 11:21:48
         compiled from "./templates/mpos/statistics/round/round_transactions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:144889509552beab78041302-29212793%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '144889509552beab78041302-29212793',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52beab780d71c1_60763607',
  'variables' => 
  array (
    'ROUNDTRANSACTIONS' => 0,
    'GLOBAL' => 0,
...
<?php if ($_valid && !is_callable('content_52beab780d71c1_60763607')) {function content_52beab780d71c1_60763607($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include './include/smarty/libs/plugins/function.cycle.php';
...
"<?php }?>>
        <td><?php if ((($tmp = @$_smarty_tpl->tpl_vars['ROUNDTRANSACTIONS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['txs']['index']]['is_anonymous'])===null||$tmp==='' ? "0" : $tmp)==1&&(($tmp = @$_smarty_tpl->tpl_vars['GLOBAL']->value['userdata']['is_admin'])===null||$tmp==='' ? "0" : $tmp)==0){?>anonymous<?php }else{ ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ROUNDTRANSACTIONS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['txs']['index']]['username'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?></td>
        ...
        <td align="right" style="padding-right: 25px;"><?php echo $_smarty_tpl->tpl_vars['ROUNDTRANSACTIONS']->value[$_smarty_tpl->getVariable('smarty')->value['section']['txs']['index']]['amount']*95/number_format((($tmp = @100)===null||$tmp==='' ? "0" : $tmp),"8");?>
</td>
      </tr>
<?php endfor; endif; ?>
